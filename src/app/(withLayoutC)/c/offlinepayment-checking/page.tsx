...
import { OfflinePaymentData } from "@/constants/paymentData";
import { IOfflinePayment } from "@/types/payment";
...
const OnlinePaymentChecking = () => {
  ...
  let columns = [
    ...
    { title: "Recept Person ID", dataIndex: "receiptPersonId" },
    { title: "Check number", dataIndex: "checkNumber" },
    { title: "Check security code", dataIndex: "checkSecurityCode" },
    { title: "Check Amount", dataIndex: "checkAmount" },
    { title: "Check Holder Name", dataIndex: "checkHolderName" },
    { title: "Day of payment", dataIndex: "paymentDay" },
    { title: "Status", dataIndex: "status" },
    {
      title: "See",
      render: (data: IOfflinePayment) => {
        return (
          <span>
            <Link href={`/c/offlinepayment-checking/view/${data?.paymentId}`}>
  ...
  return (
    <div>
      ...
      <ICTable
        loading={false}
        columns={columns}
        dataSource={OfflinePaymentData}
        pageSize={size}
        totalPages={OfflinePaymentData?.length}
